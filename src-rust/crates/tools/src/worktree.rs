...
impl Tool for EnterWorktreeTool {
    ...
    fn input_schema(&self) -> Value {
        json!({
            ...
            "properties": {
                "branch": {
                    "type": "string",
                    "description": "Branch name to create. Defaults to a timestamped name like simon-20240101-120000."
                },
                "path": {
                    "type": "string",
    ...
    async fn execute(&self, input: Value, ctx: &ToolContext) -> ToolResult {
        ...
        let branch = params.branch.clone().unwrap_or_else(|| {
            ...
            format!("simon-{:04}{:02}{:02}-{:02}{:02}{:02}", year, month, day, h, m, s)
        });
