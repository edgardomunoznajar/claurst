...
// ~/.simon/remote-settings.json, and polls every hour in the background.
...
/// On-disk cache structure stored in ~/.simon/remote-settings.json.
...
/// Return the ~/.simon directory, falling back to the current directory.
