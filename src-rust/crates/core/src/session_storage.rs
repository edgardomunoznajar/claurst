// session_storage.rs — JSONL transcript persistence for Simon.
//
// File layout:  ~/.simon/projects/{base64url(project_root)}/{session_id}.jsonl
//
...
pub struct TranscriptMessage {
    ...
    /// Version of the Simon binary, mirrors `MACRO.VERSION`.
    #[serde(default)]
    pub version: String,
...
/// Returns the base projects directory: `~/.simon/projects/`.
