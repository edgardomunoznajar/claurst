...
use simon_core::config::McpServerConfig;
use simon_core::mcp_templates::TemplateRenderer;
        ...
        async fn initialize(mut self) -> anyhow::Result<Self> {
            let params = InitializeParams {
                ...
                client_info: ClientInfo {
                    name: simon_core::constants::APP_NAME.to_string(),
                    version: simon_core::constants::APP_VERSION.to_string(),
                },
            };
...
impl McpManager {
    ...
    pub async fn initiate_auth(&self, server_name: &str) -> anyhow::Result<String> {
        ...
        // 4. Build auth URL
        let auth_url = format!(
            "{}?client_id=simon&redirect_uri={}&response_type=code&code_challenge={}&code_challenge_method=S256",
