...
// Shown briefly in the message area when Simon updates a memory file
// (e.g. ~/.simon/AGENTS.md or a project-local AGENTS.md).
//
...
use crate::overlays::{SIMON_ACCENT, SIMON_MUTED, SIMON_PANEL_BG, SIMON_TEXT};
...
pub fn render_memory_update_notification(
    ...
    let line = Line::from(vec![
        ...
        Span::styled("\u{1f9e0} ", Style::default().fg(SIMON_ACCENT)),
        Span::styled("Memory updated in ", Style::default().fg(SIMON_TEXT)),
        Span::styled(
            display_path,
            Style::default()
                .fg(SIMON_ACCENT)
        ...
        Span::styled(" \u{00b7} ", Style::default().fg(SIMON_MUTED)),
        Span::styled(
            "/memory",
            Style::default()
                .fg(SIMON_ACCENT)
        ...
        Span::styled(" to edit", Style::default().fg(SIMON_MUTED)),
        Span::styled("  Esc dismiss", Style::default().fg(SIMON_MUTED)),
    ]);
...
mod tests {
    ...
    fn memory_notif_show_and_dismiss() {
        ...
        state.show("/home/user/.simon/AGENTS.md");
        assert!(state.visible);
        assert_eq!(state.memory_path, "/home/user/.simon/AGENTS.md");
        state.dismiss();
        assert!(!state.visible);
    }
